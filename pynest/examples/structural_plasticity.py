...
where structural plasticity is used. The network has 1000 neurons, 80% excitatory and 20% 
inhibitory. The simulation starts without any connectivity. A set of homostatic rules are
defined, according to which structural plasticity will create and delete synapses
dynamically during the simulation until a desired level of electrical activity is reached. 
The model of structural plasticity used here corresponds to the formulation presented
...
class StructralPlasticityExample:
	...
	elements. The growth of these elements is guided by homostatic rules, defined
	as growth curves.       
	...
	will be updated inside the network. It is important to notice thata synaptic elements
    ...
    we create the function record_ca. Here we use the GetStatus function to retreieve the 
    ...
    we create the function record_connectivity. Here we use the GetStatus function to retreieve the 
