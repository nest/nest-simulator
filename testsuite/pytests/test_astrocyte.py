...
"""
Test astrocyte model against SciPy reference solution.

This test compares the output of NEST's implementation against reference data stored in ``test_astrocyte.dat``, which has been generated by the SciPy ODEINT solver (see
`Astrocyte Reference Implementation notebook <doc/htmldoc/model_details/astrocyte_model_implementation.ipynb>`_).
