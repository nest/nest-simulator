...
std::vector< double_t > displacement( const std::vector< double_t >& point, const index node_gid );
...
double_t get_value( const std::vector< double_t >& point, const ParameterDatum& param );
