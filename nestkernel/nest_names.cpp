...
const Name f_IP3R_astro( "f_IP3R_astro" );
...
const Name K_act_astro( "K_act_astro" );
const Name K_inh_astro( "K_inh_astro" );
const Name K_IP3_1_astro( "K_IP3_1_astro" );
const Name K_IP3_2_astro( "K_IP3_2_astro" );
const Name K_SERCA_astro( "K_SERCA_astro" );
...
const Name r_ER_cyt_astro( "r_ER_cyt_astro" );
const Name r_IP3_astro( "r_IP3_astro");
const Name r_IP3R_astro( "r_IP3R_astro" );
const Name r_L_astro( "r_L_astro" );
...
const Name SIC( "SIC" );
const Name SIC_thr_astro( "SIC_thr_astro" );
...
const Name v_IP3R_astro( "v_IP3R_astro" );
...
const Name v_SERCA_astro( "v_SERCA_astro" );
