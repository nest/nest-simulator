...
const Name adam_beta1( "adam_beta1" );
const Name adam_beta2( "adam_beta2" );
const Name adam_epsilon( "adam_epsilon" );
const Name adam_m( "adam_m" );
const Name adam_v( "adam_v" );
...
const Name start_learning( "start_learning" );
...
const Name V_m( "V_m" );
const Name V_m_pseudo_deriv( "V_m_pseudo_deriv" );
