...
nest::glif::Parameters_::Parameters_()
  : V_reset_( -77.4 )                            // mV
  , th_inf_( 26.5 )                              // in mV
  , G_( 4.6951 )                                 // in nS
  , E_L_( -77.4 )                                // in mv
...
void
nest::glif::Parameters_::get( DictionaryDatum& d ) const
{
...
void
nest::glif::Parameters_::set( const DictionaryDatum& d )
{
...
void
nest::glif::State_::get( DictionaryDatum& d ) const
{
...
nest::glif::Buffers_::Buffers_( glif& n )
  : logger_( n )
{
}
...
void
nest::glif::init_state_( const Node& proto )
{
  const glif& pr = downcast< glif >( proto );
  S_ = pr.S_;
}

void
nest::glif::init_buffers_()
{
...
void
nest::glif::handle( CurrentEvent& e )
{
  assert( e.get_delay_steps() > 0 );
...
void
nest::glif::handle( DataLoggingRequest& e )
{
