...
The components of \lstinline!'extent'! should be numbers that can be
expressed exactly as binary fractions. This is automatically ensured 
for integer values. Otherwise, under rare circumstances, subtle 
...
Also the components of \lstinline!'center'! should be numbers that
can be expressed exactly as binary fractions, see Sec.~\ref{sec:setextent}
