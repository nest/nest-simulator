...
private:
  ...
  struct State_
  {
     ...
     */
    void set( const DictionaryDatum&, const Parameters_&, const double, NodeInterface* );
  }; // State_
...
inline port
iaf_psc_alpha_multisynapse::send_test_event( NodeInterface& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
