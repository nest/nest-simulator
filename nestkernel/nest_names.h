...
const std::string combine_thread_write( "combine_thread_write" );
...
const std::string include_label( "include_label" );
const std::string ignore_and_spike( "ignore_and_spike" );
const std::string ignore_and_spike_offset( "ignore_and_spike_offset" );
const std::string ignore_and_spike_interval( "ignore_and_spike_interval" );
...
const std::string skip_header_comment( "skip_header_comment" );
