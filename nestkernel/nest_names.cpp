...
const Name alpha_SIC( "alpha_SIC" );
...
const Name delay_SIC( "delay_SIC" );
const Name delay_astro2post( "delay_astro2post" );
const Name delay_pre2astro( "delay_pre2astro" );
const Name delay_pre2post( "delay_pre2post" );
