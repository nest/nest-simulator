...
RecordablesMap< aeif_cond_alpha_astro >::create()
{
  ...
  insert_( names::V_m, &aeif_cond_alpha_astro::get_y_elem_< aeif_cond_alpha_astro::State_::V_M > );
...
void
nest::aeif_cond_alpha_astro::Parameters_::set( const DictionaryDatum& d )
{
...
void
nest::aeif_cond_alpha_astro::State_::set( const DictionaryDatum& d, const Parameters_& )
{
