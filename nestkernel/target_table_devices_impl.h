...
inline void
nest::TargetTableDevices::get_synapse_status_to_device( const thread tid, const index source_gid, const synindex syn_id, DictionaryDatum& d, const port p ) const
{
...
inline void
nest::TargetTableDevices::get_synapse_status_from_device( const thread tid, const index ldid, const synindex syn_id, DictionaryDatum& d, const port p ) const
{
  (*target_from_devices_[ tid ])[ ldid ]->get_synapse_status( syn_id, d, p );
}

inline void
nest::TargetTableDevices::set_synapse_status_to_device( const thread tid, const index source_gid, const synindex syn_id, ConnectorModel& cm, const DictionaryDatum& d, const port p )
{
  const index lid = kernel().vp_manager.gid_to_lid( source_gid );
...
inline void
nest::TargetTableDevices::set_synapse_status_from_device( const thread tid, const index ldid, const synindex syn_id, ConnectorModel& cm, const DictionaryDatum& d, const port p )
{
  (*target_from_devices_[ tid ])[ ldid ]->set_synapse_status( syn_id, cm, d, p );
}
