...
namespace nest  // template specialization must be placed in namespace
{
  ...
  template <>
  void RecordablesMap<aeif_cond_alpha_RK5>::create()
  {
...
void nest::aeif_cond_alpha_RK5::State_::set(const DictionaryDatum& d, const Parameters_&)
{
...
void nest::aeif_cond_alpha_RK5::init_state_(const Node& proto)
{
  const aeif_cond_alpha_RK5& pr = downcast<aeif_cond_alpha_RK5>(proto);
  S_ = pr.S_;
}

void nest::aeif_cond_alpha_RK5::init_buffers_()
{
...
void nest::aeif_cond_alpha_RK5::calibrate()
{
 ...
 * @param to
 */
void nest::aeif_cond_alpha_RK5::update(Time const & origin, const long_t from, const long_t to) // proceed in time
{
...
void nest::aeif_cond_alpha_RK5::handle(SpikeEvent & e)
{
...
void nest::aeif_cond_alpha_RK5::handle(CurrentEvent& e)
{
  assert(e.get_delay() > 0);
...
void nest::aeif_cond_alpha_RK5::handle(DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}
