...
(exponential function).
  ...
  tau_syn_in double - Characteristic decrease time of the inhibitory synaptic conductance in ms
(exponential function).
 ...
 */
extern "C" int aeif_cond_exp_ps_dynamics( double, const double*, double*, void* );
...
public:
  ...
  */
  struct Buffers_
  {
    ...
    Buffers_( const Buffers_&, aeif_cond_exp_ps& ); //!<Sets buffer pointers to 0
...
inline port
aeif_cond_exp_ps::send_test_event( Node& target, port receptor_type, synindex, bool )
{
...
inline port
aeif_cond_exp_ps::handles_test_event( DataLoggingRequest& dlr, port receptor_type )
{
  // You should usually not change the code in this function.
  // It confirms to the connection management system that we are able
