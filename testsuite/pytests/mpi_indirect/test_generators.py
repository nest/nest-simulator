...
@pytest.mark.parametrize(
    "gen_model, params, params_as_defaults",
    [
        ...
        [
            ...
            {"rate": 1000, "amplitude": 1000, "frequency": 100},
            {"individual_spike_trains": False},
        ],
        [
            "sinusoidal_poisson_generator",
...
def test_generators(gen_model, params, params_as_defaults):
    """
    ...
    nest.SetDefaults(gen_model, params_as_defaults)
