...
namespace nest
{
  ...
  /* BeginDocumentation
     ...
     tau_v        double - Time constant of kernel for voltage-dependent threshold component in ms [3, eqs 16-17]
     beta         double - Scaling coefficient for voltage-dependent threshold component in 1/ms [3, eqs 16-17]
  ...
  */
  ...
  private:
    ...
    double_t get_V_th_() const { return P_.U0_ + P_.omega_ + S_.V_th_1_ + S_.V_th_2_ + S_.V_th_v_; }
    double_t get_V_th_v_() const { return S_.V_th_v_; }
  ...
  inline
  port amat2_psc_exp::send_test_event(Node& target, rport receptor_type, synindex, bool)
  {
    SpikeEvent e;
    e.set_sender(*this);
  ...
  inline
  port amat2_psc_exp::handles_test_event(SpikeEvent&, rport receptor_type)
  {
    if (receptor_type != 0)
  ...
  inline
  port amat2_psc_exp::handles_test_event(CurrentEvent&, rport receptor_type)
  {
    if (receptor_type != 0)
      throw UnknownReceptorType(receptor_type, get_name());
    return 0;
  ...
  inline
    port amat2_psc_exp::handles_test_event(DataLoggingRequest& dlr, rport receptor_type)
  {
    if (receptor_type != 0)
      throw UnknownReceptorType(receptor_type, get_name());
  ...
  inline
  void amat2_psc_exp::get_status(DictionaryDatum &d) const
  {
    P_.get(d);
    S_.get(d, P_);
  ...
  inline
  void amat2_psc_exp::set_status(const DictionaryDatum &d)
  {
