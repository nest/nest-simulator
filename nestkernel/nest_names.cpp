...
const Name a_reset( "a_reset" );
const Name a_spike( "a_spike" );
const Name a_thresh_th( "a_thresh_th" );
const Name a_thresh_tl( "a_thresh_tl" );
const Name a_voltage( "a_voltage" );
...
const Name b( "b" );
const Name b_reset( "b_reset" );
const Name b_spike( "b_spike" );
const Name b_voltage( "b_voltage" );
