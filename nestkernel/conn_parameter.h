...
public:
   ...
   */
  virtual double value_double( thread, RngPtr, index, NodeInterface* ) const = 0;
  virtual long value_int( thread, RngPtr, index, NodeInterface* ) const = 0;
  virtual void
...
public:
  ...
  double
  value_double( thread, RngPtr, index, NodeInterface* ) const override
  {
    return value_;
  }

  long
  value_int( thread, RngPtr, index, NodeInterface* ) const override
  {
...
public:
  ...
  double
  value_double( thread tid, RngPtr, index, NodeInterface* ) const override
  {
    if ( next_[ tid ] != values_->end() )
    {
      return *next_[ tid ]++;
...
public:
  ...
  long
  value_int( thread tid, RngPtr, index, NodeInterface* ) const override
  {
    if ( next_[ tid ] != values_->end() )
    {
      return *next_[ tid ]++;
...
public:
  ...
  double value_double( thread target_thread, RngPtr rng, index snode_id, NodeInterface* target ) const override;

  long
  value_int( thread target_thread, RngPtr rng, index snode_id, NodeInterface* target ) const override
  {
