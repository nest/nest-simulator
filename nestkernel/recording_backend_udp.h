...
#ifndef RECORDING_BACKEND_UDP_H
#define RECORDING_BACKEND_UDP_H
 ...
 * screen.
 */
class RecordingBackendUDP : public RecordingBackend
{
public:
  RecordingBackendUDP()
  {
