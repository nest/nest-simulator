...
namespace nest  // template specialization must be placed in namespace
{
  ...
  void RecordablesMap<iaf_cond_exp>::create()
  {
    ...
    insert_(names::V_m, 
	    &iaf_cond_exp::get_y_elem_<iaf_cond_exp::State_::V_M>);
    insert_(names::g_ex, 
	    &iaf_cond_exp::get_y_elem_<iaf_cond_exp::State_::G_EXC>);
    insert_(names::g_in, 
	    &iaf_cond_exp::get_y_elem_<iaf_cond_exp::State_::G_INH>);
  }
}

extern "C"
inline int nest::iaf_cond_exp_dynamics(double, const double y[], double f[], void* pnode)
{ 
  // a shorthand
...
void nest::iaf_cond_exp::State_::set(const DictionaryDatum& d, const Parameters_&)
{
...
void nest::iaf_cond_exp::init_buffers_()
{
...
void nest::iaf_cond_exp::calibrate()
{
...
void nest::iaf_cond_exp::update(Time const & origin, const long_t from, const long_t to)
{
...
void nest::iaf_cond_exp::handle(SpikeEvent & e)
{
...
void nest::iaf_cond_exp::handle(CurrentEvent& e)
{
  assert(e.get_delay() > 0);
...
void nest::iaf_cond_exp::handle(DataLoggingRequest& e)
{
  B_.logger_.handle(e);
}
