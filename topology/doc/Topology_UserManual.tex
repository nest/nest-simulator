...
\item The \lstinline!'elements'! entry of the dictionary passed to
  ...
  contains \lstinline!iaf_psc_alpha!s.
...
following code creates a layer of 50 \lstinline!iaf_psc_alphas! uniformly
...
\lstinline!topology_layer_grid! subnet of 25 \lstinline!iaf_psc_alpha!s.
...
\lstinline!iaf_psc_alpha!s with default parameter values, while
interneurons are \lstinline!iaf_psc_alpha!s with threshold voltage
$V_{\text{th}}=-52$mV. 
\end{quote}
