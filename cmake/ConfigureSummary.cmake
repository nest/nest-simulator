...
function( NEST_PRINT_CONFIG_SUMMARY )
  ...
  if ( NEST_PREBUILT_PYNEST_CXX STREQUAL "" )
    ...
    message( "    Cython          : Not run; using pre-generated ${NEST_PREBUILT_PYNEST_CXX}" )
  endif ()
  ...
  if ( NOT NEST_PREBUILT_PYNEST_CXX STREQUAL ""
       AND NOT EXISTS "${NEST_PREBUILT_PYNEST_CXX}" )
    message( "" )
    message( "ATTENTION!" )
    message( "You configured NEST with -Dwith-prebuilt-pynest-cxx=ON but the" )
    message( "pre-generated C++ file is not yet present:" )
    message( "  ${NEST_PREBUILT_PYNEST_CXX}" )
