...
function( NEST_PRINT_CONFIG_SUMMARY )
  ...
  if ( HAVE_BOOST )
    ...
    if ( "${BOOST_VERSION}" VERSION_GREATER_EQUAL "1.69" )
      message( "Use Boost           : Boost disabled due to version missmatch. Version must be less than 1.69.0 (Found Version: ${BOOST_VERSION})" )
    else ()
