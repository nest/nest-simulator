...
In this example, we reproduce Figure 1B in :footcite:p:`Tsodyks1998`. We connect two
...
###############################################################################
# Next, we set the synaptic parameters according to :footcite:p:`Tsodyks1998`.
