...
def brunel_tsodyks_network(
    ...
    nu_thresh = neuron_params["V_th"] / (JE * model_params["CE"] * neuron_params["tau_m"])
    ...
    nodes_exc = nest.Create("iaf_psc_exp", model_params["NE"], params=neuron_params)

    # Create inhibitory nodes
    nodes_inh = nest.Create("iaf_psc_exp", model_params["NI"], params=neuron_params)
    ...
    nest.CopyModel("tsodyks_synapse", "tso_syn_exc", params={"weight": JE, "U": model_params["U_ex"]})

    # Inhibitory synapse model
    nest.CopyModel("tsodyks_synapse", "tso_syn_inh", params={"weight": JI, "U": model_params["U_in"]})
