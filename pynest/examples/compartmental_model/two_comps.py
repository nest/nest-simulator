...
syn_idx_soma_pas = nest.AddReceptor(cm_pas, 0, "AMPA+NMDA")
syn_idx_dend_pas = nest.AddReceptor(cm_pas, 1, "AMPA+NMDA")
# add somatic and dendritic receptor to active dendrite model
syn_idx_soma_act = nest.AddReceptor(cm_act, 0, "AMPA+NMDA")
syn_idx_dend_act = nest.AddReceptor(cm_act, 1, "AMPA+NMDA")
