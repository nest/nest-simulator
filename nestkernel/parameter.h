...
public:
   ...
   */
  virtual double value( RngPtr rng, NESTObjectInterface* node ) = 0;
...
public:
   ...
   */
  double
  value( RngPtr, NESTObjectInterface* ) override
  {
    return value_;
  }
...
public:
  ...
  double
  value( RngPtr rng, NESTObjectInterface* ) override
  {
...
public:
  ...
  double value( RngPtr rng, NESTObjectInterface* node ) override;
...
public:
  ...
  double
  value( RngPtr, NESTObjectInterface* node ) override
  {
...
private:
  ...
  double get_node_pos_( NESTObjectInterface* node ) const;
};
...
public:
   ...
   */
  double
  value( RngPtr rng, NESTObjectInterface* node ) override
  {
  ...
  value( RngPtr rng,
    ...
    const std::vector< double >& target_pos,
    const AbstractLayer& layer,
    NESTObjectInterface* node ) override
  {
