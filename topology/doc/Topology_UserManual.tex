...
\lstset{% Settings for the listing package
  ...
  morekeywords={Create,SetStatus,GetStatus,Connect,
    ...
    CreateLayer,ConnectLayers,GetPosition,FindNearestElement,
    Displacement,Distance,DumpLayerNodes,DumpLayerConnections,
    FindCenterElement,GetTargetNodes,GetTargetPositions,SelectNodesByMask,
...
\begin{longtable}{lp{0.6\linewidth}}
  ...
  \url{https://www.nest-simulator.org/connection_management}. \\
...
&
    Add indication of mask and kernel to plot of layer. This function
