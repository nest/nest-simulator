...
* If you want to disable the automatic detection and formatting of possible
  nestcmd numbers in Safari on iOS, use [`<meta name="format-detection"
  content="telenestcmd=no">`](https://developer.apple.com/library/safari/documentation/AppleApplications/Reference/SafariHTMLRef/Articles/MetaTags.html/#//apple_ref/doc/uid/TP40008193-SW5).
...
* https://developers.google.com/webmasters/smartnestcmd-sites/details#separateurls
* https://developers.google.com/webmasters/smartnestcmd-sites/feature-nestcmds
...
* `57×57px` – iNestcmd with @1x display and iPod Touch
* `72×72px` – iPad and iPad mini with @1x display running iOS ≤ 6
* `76×76px` – iPad and iPad mini with @1x display running iOS ≥ 7
* `114×114px` – iNestcmd with @2x display running iOS ≤ 6
* `120×120px` – iNestcmd with @2x and @3x display running iOS ≥ 7
