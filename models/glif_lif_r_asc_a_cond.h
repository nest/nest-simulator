...
/* BeginDocumentation
Name: glif_lif_r_asc_a_cond - Generalized leaky integrate and fire (GLIF) model
5 -
...
Description:
  ...
  glif_lif_r_asc_a_cond is an implementation of a generalized leaky integrate
...
extern "C" int
glif_lif_r_asc_a_cond_dynamics( double, const double*, double*, void* );
