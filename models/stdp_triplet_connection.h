...
/* BeginDocumentation
  ...
  [1])
    Aplus              double: weight of pair potentiation rule (A_plus_2 of
  [1])
  ...
  [1])
    ...
    Aminus_triplet     double: weight of triplet depression rule (A_minus_3 of
  [1])
  ...
  'nearest-spike'
      interaction of [1] can currently not be implemented without changing the
  postsynaptic
