...
namespace nest {
  ...
  public:
    ...
    class const_iterator {
      ...
      const_iterator(const GIDCollection* gc, size_t offset) : gc_(gc), offset_(offset) {}
  ...
  inline
  index GIDCollection::const_iterator::operator*() const
  {
    return (*gc_)[offset_]; 
  }

  inline
  const GIDCollection::const_iterator& GIDCollection::const_iterator::operator++()
  {
    ++offset_;
    return *this;
  }
  ...
  inline
  bool GIDCollection::const_iterator::operator!=(const GIDCollection::const_iterator& rhs) const
  {
    return offset_ != rhs.offset_;
  }

  inline
  index GIDCollection::operator[] (const size_t pos) const
  {
    if ((is_range_ && pos + gid_range_.first > gid_range_.second) || (!is_range_ && pos >= gid_array_.size()))
  ...
  inline
  bool GIDCollection::operator==(const GIDCollection& rhs) const
  {
    if (is_range_)
  ...
  inline
  GIDCollection::const_iterator GIDCollection::begin() const
  {
    return const_iterator(this, 0);
  }

  inline
  GIDCollection::const_iterator GIDCollection::end() const
  {
    return const_iterator(this, size());
  }

  inline
  size_t GIDCollection::size() const
  {
    if (is_range_)
