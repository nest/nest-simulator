...
const std::string forced_spiking( "forced_spiking" );
const std::string forced_spiking_offset( "forced_spiking_offset" );
const std::string forced_spiking_interval( "forced_spiking_interval" );
