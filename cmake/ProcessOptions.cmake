...
function( NEST_PROCESS_TARGET_BITS_SPLIT )
  if ( target-bits-split )
    if ( ${target-bits-split} STREQUAL "standard" )
      set( NUM_BITS_RANK 18 )
      set( NUM_BITS_TID 9 )
      set( NUM_BITS_SYN_ID 9 )
      set( NUM_BITS_LCID 27 )
      set( NUM_BITS_PROCESSED_FLAG 1 )
    elseif ( ${target-bits-split} STREQUAL "hpc" )
      set( NUM_BITS_RANK 20 )
      set( NUM_BITS_TID 10 )
      set( NUM_BITS_SYN_ID 6 )
      set( NUM_BITS_LCID 27 )
      set( NUM_BITS_PROCESSED_FLAG 1 )
    else()
      string( REPLACE "-" " " TARGET_BITS_SPLIT_LIST ${target-bits-split} )
      separate_arguments( TARGET_BITS_SPLIT_LIST )
      list( GET TARGET_BITS_SPLIT_LIST 0 NUM_BITS_RANK)
      list( GET TARGET_BITS_SPLIT_LIST 1 NUM_BITS_TID)
      list( GET TARGET_BITS_SPLIT_LIST 2 NUM_BITS_SYN_ID)
      list( GET TARGET_BITS_SPLIT_LIST 3 NUM_BITS_LCID)
      list( GET TARGET_BITS_SPLIT_LIST 4 NUM_BITS_PROCESSED_FLAG)
    endif()
    set( NUM_BITS_RANK ${NUM_BITS_RANK}U PARENT_SCOPE )
    set( NUM_BITS_TID ${NUM_BITS_TID}U PARENT_SCOPE )
    set( NUM_BITS_SYN_ID ${NUM_BITS_SYN_ID}U PARENT_SCOPE )
    set( NUM_BITS_LCID ${NUM_BITS_LCID}U PARENT_SCOPE )
    set( NUM_BITS_PROCESSED_FLAG ${NUM_BITS_PROCESSED_FLAG}U PARENT_SCOPE )
  endif()
endfunction()
