...
class BaseTestCases:
    ...
    class Random123TestCase(unittest.TestCase):
        ...
        def setUp(self):
            nest.ResetKernel()
            nest.set({'rng_type': self.rng_type})
...
@unittest.skipIf('Philox_32' not in nest.get('rng_types'), not_supported_msg('Random123'))
class Philox32TestCase(BaseTestCases.Random123TestCase):
    rng_type = 'Philox_32'


@unittest.skipIf('Philox_64' not in nest.get('rng_types'), not_supported_msg('Philox_64'))
class Philox64TestCase(BaseTestCases.Random123TestCase):
    rng_type = 'Philox_64'


@unittest.skipIf('Threefry_32' not in nest.get('rng_types'), not_supported_msg('Random123'))
class Threefry32TestCase(BaseTestCases.Random123TestCase):
    rng_type = 'Threefry_32'


@unittest.skipIf('Threefry_64' not in nest.get('rng_types'), not_supported_msg('Threefry_64'))
