...
size_t
ModelManager::copy_node_model_( size_t old_id, std::string new_name )
{
...
size_t
ModelManager::copy_connection_model_( size_t old_id, std::string new_name )
{
