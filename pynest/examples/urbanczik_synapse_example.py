...
nrn_params = {
    ...
    'g_sp': 600.0,       # soma-to-proximal coupling conductance
    'soma': {
...
syn_params = {
    ...
    'weight': init_w,
    'Wmax': 3.0*nrn_params['proximal']['g_L'],
    'delay': resolution,
}
'''
...
somatic input
'''
ampl_exc = 0.016*nrn_params['proximal']['C_m']
offset = 0.018*nrn_params['proximal']['C_m']
ampl_inh = 0.06*nrn_params['proximal']['C_m']
