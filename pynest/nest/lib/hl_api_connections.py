...
def Connect(pre, post, conn_spec=None, syn_spec=None, return_synapsecollection=False):
    ...
    **Synapse specification (syn_spec)**
    ...
    if use_connect_arrays:
        ...
        axonal_delays = numpy.array(processed_syn_spec["axonal_delay"]) if "axonal_delay" in processed_syn_spec else None
        ...
        reduced_processed_syn_spec = {
            ...
            for k in set(processed_syn_spec.keys()).difference(set(("weight", "delay", "axonal_delay", "synapse_model")))
        }
