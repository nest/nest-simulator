...
nest::RecordablesMap< nest::aeif_psc_alpha_ps > nest::aeif_psc_alpha_ps::recordablesMap_;
...
{
  insert_(
    names::V_m, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::V_M > );
  insert_(
    names::I_ex, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::I_EXC > );
  insert_(
    names::I_in, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::I_INH > );
  insert_( names::w, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::W > );
}
}
...
extern "C" int
nest::aeif_psc_alpha_ps_dynamics( double, const double y[], double f[], void* pnode )
{
  // a shorthand
  ...
  assert( pnode );
  const nest::aeif_psc_alpha_ps& node = *( reinterpret_cast< nest::aeif_psc_alpha_ps* >( pnode ) );
  ...
  // dv/dt
  f[ S::V_M ] = ( -node.P_.g_L * ( ( V - node.P_.E_L ) - I_spike ) + I_ex - I_in - w + node.P_.I_e
...
nest::aeif_psc_alpha_ps::State_& nest::aeif_psc_alpha_ps::State_::operator=( const State_& s )
{
...
void
nest::aeif_psc_alpha_ps::State_::set( const DictionaryDatum& d, const Parameters_& )
{
...
nest::aeif_psc_alpha_ps::Buffers_::Buffers_( const Buffers_&, aeif_psc_alpha_ps& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
void
nest::aeif_psc_alpha_ps::spiking_( const long_t T, const long_t lag, const double t )
{
  // spike event
...
void
nest::aeif_psc_alpha_ps::update( const Time& origin, const long_t from, const long_t to )
{
