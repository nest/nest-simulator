#ifndef GLIF_LIF_ASC_COND_H
#define GLIF_LIF_ASC_COND_H
...
extern "C" int glif_lif_asc_cond_dynamics( double, const double*, double*, void* );

class glif_lif_asc_cond : public nest::Archiving_Node
{
public:

  glif_lif_asc_cond();

  glif_lif_asc_cond( const glif_lif_asc_cond& );
...
private:
  ...
  friend int glif_lif_asc_cond_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class nest::RecordablesMap< glif_lif_asc_cond >;
  friend class nest::UniversalDataLogger< glif_lif_asc_cond >;
  ...
  struct Buffers_
  {
    Buffers_( glif_lif_asc_cond& );
    Buffers_( const Buffers_&, glif_lif_asc_cond& );
    ...
    nest::UniversalDataLogger< glif_lif_asc_cond > logger_;
...
inline size_t
nest::glif_lif_asc_cond::Parameters_::n_receptors_() const
{
  return tau_syn_.size();
}

inline size_t
nest::glif_lif_asc_cond::Parameters_::n_ASCurrents_() const
{
  return k_.size();
}
...
inline nest::port
nest::glif_lif_asc_cond::send_test_event( nest::Node& target,
...
inline nest::port
nest::glif_lif_asc_cond::handles_test_event( nest::CurrentEvent&,
  nest::port receptor_type )
{
  if ( receptor_type != 0 ){
...
inline nest::port
nest::glif_lif_asc_cond::handles_test_event( nest::DataLoggingRequest& dlr,
  nest::port receptor_type )
{
  if ( receptor_type != 0 ){
    throw nest::UnknownReceptorType( receptor_type, get_name() );
...
inline void
glif_lif_asc_cond::get_status( DictionaryDatum& d) const
{
...
inline void
glif_lif_asc_cond::set_status( const DictionaryDatum& d )
{
