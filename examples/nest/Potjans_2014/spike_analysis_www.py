...
f = open(datapath + 'sim_params.sli', 'r')
for line in f:
  if 't_sim' in line:
...
gidfile = open(datapath + 'population_GIDs.dat','r')
gids = [] 
for l in gidfile:
  a = l.split()
...
for layer in ['0','1','2','3']:
  for population in ['0','1']:
    output = datapath + 'population_spikes-'+ layer+'-'+population+'.gdf'
    file_pattern = datapath + 'spikes_'+ layer+'_'+population+'*'
...
plt.savefig(datapath + 'rasterplot.png')
...
plt.savefig(datapath + 'firing_rates.png')
