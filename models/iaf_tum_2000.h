...
namespace nest
{
  ...
  */
  ...
  private:
    ...
    double_t get_V_m_() const { return S_.V_m_; }
...
inline
port iaf_tum_2000::send_test_event(Node& target, rport receptor_type, synindex, bool)
{
  SpikeEvent e;
  e.set_sender(*this);
...
inline
port iaf_tum_2000::handles_test_event(SpikeEvent&, rport receptor_type)
{
  if (receptor_type != 0)
...
inline
port iaf_tum_2000::handles_test_event(CurrentEvent&, rport receptor_type)
{
  if (receptor_type != 0)
    throw UnknownReceptorType(receptor_type, get_name());
  return 0;
...
inline
port iaf_tum_2000::handles_test_event(DataLoggingRequest& dlr, 
				       rport receptor_type)
{
  if (receptor_type != 0)
    throw UnknownReceptorType(receptor_type, get_name());
  ...
  inline
    void iaf_tum_2000::get_status(DictionaryDatum &d) const
  {
    P_.get(d);
    S_.get(d, P_);
  ...
  inline
    void iaf_tum_2000::set_status(const DictionaryDatum &d)
  {
