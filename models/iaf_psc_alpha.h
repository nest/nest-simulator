...
private:
  ...
  struct State_
  {
     ...
     */
    void set( const DictionaryDatum&, const Parameters_&, double, NodeInterface* node );
  };
...
inline port
nest::iaf_psc_alpha::send_test_event( NodeInterface& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
