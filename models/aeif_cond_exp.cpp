...
namespace nest
{
  ...
  void RecordablesMap<aeif_cond_exp>::create()
  {
    ...
    insert_(names::V_m, 
	    &aeif_cond_exp::get_y_elem_<aeif_cond_exp::State_::V_M>);
    insert_(names::g_ex, 
	    &aeif_cond_exp::get_y_elem_<aeif_cond_exp::State_::G_EXC>);
    insert_(names::g_in, 
	    &aeif_cond_exp::get_y_elem_<aeif_cond_exp::State_::G_INH>);
    insert_(names::w, 
	    &aeif_cond_exp::get_y_elem_<aeif_cond_exp::State_::W>);
  }
}

extern "C"
int nest::aeif_cond_exp_dynamics (double, const double y[], double f[], void* pnode)
{
  // a shorthand
...
void nest::aeif_cond_exp::Parameters_::get(DictionaryDatum &d) const
{
...
void nest::aeif_cond_exp::Parameters_::set(const DictionaryDatum &d)
{
...
void nest::aeif_cond_exp::init_state_(const Node &proto)
{
  const aeif_cond_exp &pr = downcast<aeif_cond_exp>(proto);
  S_ = pr.S_;
}

void nest::aeif_cond_exp::init_buffers_()
{
...
void nest::aeif_cond_exp::calibrate()
{
...
void nest::aeif_cond_exp::handle(CurrentEvent &e)
{
  assert ( e.get_delay() > 0 );
...
void nest::aeif_cond_exp::handle(DataLoggingRequest &e)
{
  B_.logger_.handle(e);
}
