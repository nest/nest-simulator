...
namespace nest // template specialization must be placed in namespace
{
  ...
  {
    insert_( names::V_m, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::V_M > );
    insert_( names::I_ex, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::I_EXC > );
    insert_( names::I_in, &nest::aeif_psc_alpha_ps::get_y_elem_< nest::aeif_psc_alpha_ps::State_::I_INH > );
