...
RecordablesMap< hh_cond_beta_gap_traub >::create()
{
  ...
  insert_( names::Act_h, &hh_cond_beta_gap_traub::get_y_elem_< hh_cond_beta_gap_traub::State_::HH_H > );
  insert_( names::Inact_n, &hh_cond_beta_gap_traub::get_y_elem_< hh_cond_beta_gap_traub::State_::HH_N > );
}
