...
namespace nest
{
 ...
 private:
  ...
  template<typename targetidentifierT>
  inline
  void STDPConnectionHom<targetidentifierT>::send(Event& e, thread t, double_t t_lastspike, const STDPHomCommonProperties &cp)
  {
  ...
  template<typename targetidentifierT>
  void STDPConnectionHom<targetidentifierT>::get_status(DictionaryDatum & d) const
  {
  ...
  template<typename targetidentifierT>
  void STDPConnectionHom<targetidentifierT>::set_status(const DictionaryDatum & d, ConnectorModel &cm)
  {
