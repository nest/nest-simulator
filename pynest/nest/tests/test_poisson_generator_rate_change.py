...
class TestPgRateChange(unittest.TestCase):
    ...
    def _kstest_first_spiketimes(self, sd, start_t, expon_scale, resolution, p_value_lim):
    ...
    def test_statistical_rate_change(self):
        ...
        self._kstest_first_spiketimes(sd, 0., expon_scale, resolution, p_value_lim)
        ...
        self._kstest_first_spiketimes(sd, 2. * sim_time, expon_scale, resolution, p_value_lim)
