...
# the two desired synaptic ports of the GLIF neurons.
...
# of the 2 synaptic ports as the one mentioned above. Other neuron parameters
# are set as default. The five ``glif_psc`` node handles were combined a list.
...
###############################################################################
# For the stimulation input to the glif_psc neurons, we create one excitory
...
# i.e., 0ms~200ms, 200ms~500ms, 600ms~900 ms.
# Each of the excitatory and inhibitory spike generators generates three spikes
...
###############################################################################
# Run the simulation for 1000ms and retrieve recorded data from
...
# We plot all these three panel for each level of GLIF model in a seperated
# figure.
