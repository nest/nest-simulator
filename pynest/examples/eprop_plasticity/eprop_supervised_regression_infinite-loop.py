...
nrns_rec = nest.Create("eprop_iaf_bsshslm_2020_adapt", n_rec, params_nrn_rec)
...
params_mm_rec = {
    ...
    "record_from": ["V_m", "surrogate_gradient", "learning_signal", "V_th_adapt", "adaptation"],  # recordables
