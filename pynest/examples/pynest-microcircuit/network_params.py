...
net_dict = {
    ...
    'recording_dev': ['spike_detector', 'voltmeter'],
    ...
    'neuron_params': {
        ...
        'tau_m': 10.0,
        # Time constant of the postsynaptic excitatory currents (in ms).
        'tau_syn_ex': 0.5,
        # Time constant of the postsynaptic inhibitatory currents (in ms).
        'tau_syn_in': 0.5,
        # Time constant of the external postsynaptic excitatory current (in ms).
        'tau_syn_E': 0.5,
