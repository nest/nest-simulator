...
nest.Connect(
    nest.AllToAll(
        sg_soma_exc,
        nrn,
        syn_spec=nest.synapsemodels.static(receptor_type=syns["soma_exc"], weight=10.0 * resolution, delay=resolution),
    )
)
nest.Connect(
    nest.AllToAll(
        sg_soma_inh,
        nrn,
        syn_spec=nest.synapsemodels.static(receptor_type=syns["soma_inh"], weight=10.0 * resolution, delay=resolution),
    )
)
