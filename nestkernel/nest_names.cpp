...
const Name Ca_tot_astro( "Ca_tot_astro" );
const Name c( "c" );
const Name c_1( "c_1" );
const Name c_2( "c_2" );
const Name c_3( "c_3" );
...
const Name delay_astro( "delay_astro" );
...
const Name h_IP3R_astro( "h_IP3R_astro" );
...
const Name I_e( "I_e" );
const Name I_h( "I_h" );
const Name IP3_astro( "IP3_astro" );
const Name IP3_0_astro( "IP3_0_astro" );
...
const Name Kd_act_astro( "Kd_act_astro" );
const Name Kd_inh_astro( "Kd_inh_astro" );
const Name Kd_IP3_1_astro( "Kd_IP3_1_astro" );
const Name Kd_IP3_2_astro( "Kd_IP3_2_astro" );
const Name Km_SERCA_astro( "Km_SERCA_astro" );
...
const Name ratio_ER_cyt_astro( "ratio_ER_cyt_astro" );
const Name incr_IP3_astro( "incr_IP3_astro");
const Name k_IP3R_astro( "k_IP3R_astro" );
const Name rate_L_astro( "rate_L_astro" );
...
const Name SIC( "SIC" );
const Name SIC_th_astro( "SIC_th_astro" );
...
const Name tau_IP3_astro( "tau_IP3_astro");
...
const Name rate_IP3R_astro( "rate_IP3R_astro" );
...
const Name rate_SERCA_astro( "rate_SERCA_astro" );
...
const Name weight_pre2post( "weight_pre2post" );
const Name weight_pre2astro( "weight_pre2astro" );
const Name weight_astro2post( "weight_astro2post" );
