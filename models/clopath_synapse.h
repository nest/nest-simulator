...
public:
  ...
  clopath_synapse( const clopath_synapse& rhs, const size_t ) : clopath_synapse( rhs ) {};
...
template < typename targetidentifierT >
void
clopath_synapse< targetidentifierT >::set_status( const DictionaryDatum& d, const size_t tid, ConnectorModel& cm )
{
