...
public:
  ...
  jonke_synapse( const jonke_synapse& rhs, const size_t ) : jonke_synapse( rhs ) {};
...
template < typename targetidentifierT >
void
jonke_synapse< targetidentifierT >::set_status( const DictionaryDatum& d, const size_t tid, ConnectorModel& cm )
{
