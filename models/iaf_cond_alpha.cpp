...
void
nest::iaf_cond_alpha::Parameters_::set( const DictionaryDatum& d, NodeInterface* node )
{
...
void
nest::iaf_cond_alpha::State_::set( const DictionaryDatum& d, const Parameters_&, NodeInterface* node )
{
