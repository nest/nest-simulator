...
void nest::iaf_chs_2007::Parameters_::set(const DictionaryDatum &d, State_& s)
{
...
void nest::iaf_chs_2007::init_node_(const Node &proto)
{
...
void nest::iaf_chs_2007::init_state_(const Node &proto)
{
  const iaf_chs_2007 &pr = downcast<iaf_chs_2007>(proto);
  S_ = pr.S_;
}

void nest::iaf_chs_2007::init_buffers_()
{
...
void nest::iaf_chs_2007::calibrate()
{
...
void nest::iaf_chs_2007::handle(DataLoggingRequest &e)
{
  B_.logger_.handle(e);
}
