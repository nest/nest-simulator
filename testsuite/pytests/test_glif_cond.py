...
class GLIFCONDTestCase(unittest.TestCase):
    ...
    def simulate_w_stim(self, model_params):
        ...
        nest.Connect(nest.AllToAll(pn, nrn, syn_spec=nest.synapsemodels.static(weight=22.0, receptor_type=1)))
        nest.Connect(nest.AllToAll(pn, nrn, syn_spec=nest.synapsemodels.static(weight=10.0, receptor_type=2)))
