...
double
nest::iaf_psc_alpha_canon::Parameters_::set( const dictionary& d, Node* node )
{
...
void
nest::iaf_psc_alpha_canon::State_::set( const dictionary& d, const Parameters_& p, double delta_EL, Node* node )
{
  ...
  update_value_param( d, names::y1, y1_, node );
  update_value_param( d, names::y2, y2_, node );
}
