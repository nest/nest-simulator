...
nest::RecordablesMap< nest::iaf_cond_alpha_mc_fixedca > nest::iaf_cond_alpha_mc_fixedca::recordablesMap_;
...
{
  insert_( Name( "V_m.s" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::V_M, iaf_cond_alpha_mc_fixedca::SOMA > );
  insert_( Name( "g_ex.s" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_EXC, iaf_cond_alpha_mc_fixedca::SOMA > );
  insert_( Name( "g_in.s" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_INH, iaf_cond_alpha_mc_fixedca::SOMA > );
  insert_(Name("i_ap.s"), 
    &iaf_cond_alpha_mc_fixedca::get_y_elem_<iaf_cond_alpha_mc_fixedca::State_::I_AP, iaf_cond_alpha_mc_fixedca::SOMA>);

  insert_( Name( "V_m.p" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::V_M, iaf_cond_alpha_mc_fixedca::PROX > );
  insert_( Name( "g_ex.p" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_EXC, iaf_cond_alpha_mc_fixedca::PROX > );
  insert_( Name( "g_in.p" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_INH, iaf_cond_alpha_mc_fixedca::PROX > );
  insert_(Name("i_ap.p"), 
    &iaf_cond_alpha_mc_fixedca::get_y_elem_<iaf_cond_alpha_mc_fixedca::State_::I_AP, iaf_cond_alpha_mc_fixedca::PROX>);

  insert_( Name( "V_m.d" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::V_M, iaf_cond_alpha_mc_fixedca::DIST > );
  insert_( Name( "g_ex.d" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_EXC, iaf_cond_alpha_mc_fixedca::DIST > );
  insert_( Name( "g_in.d" ),
    &iaf_cond_alpha_mc_fixedca::get_y_elem_< iaf_cond_alpha_mc_fixedca::State_::G_INH, iaf_cond_alpha_mc_fixedca::DIST > );
  insert_(Name("i_ap.d"), 
    &iaf_cond_alpha_mc_fixedca::get_y_elem_<iaf_cond_alpha_mc_fixedca::State_::I_AP, iaf_cond_alpha_mc_fixedca::DIST>);
...
nest::iaf_cond_alpha_mc_fixedca_dynamics( double, const double y[], double f[], void* pnode )
{
  ...
  assert( pnode );
  const nest::iaf_cond_alpha_mc_fixedca& node = *( reinterpret_cast< nest::iaf_cond_alpha_mc_fixedca* >( pnode ) );
...
nest::iaf_cond_alpha_mc_fixedca::Parameters_& nest::iaf_cond_alpha_mc_fixedca::Parameters_::operator=(
  const Parameters_& p )
{
...
nest::iaf_cond_alpha_mc_fixedca::State_& nest::iaf_cond_alpha_mc_fixedca::State_::operator=( const State_& s )
{
...
nest::iaf_cond_alpha_mc_fixedca::update( Time const& origin, const long_t from, const long_t to )
{
  ...
  for ( long_t lag = from; lag < to; ++lag )
  {
    ...
    {// calcium spike 
      if (( S_.y_[DIST*State_::STATE_VEC_COMPS + State_::V_M] >= P_.V_thCa) && (P_.act_flag == 1.0))
      {	 
