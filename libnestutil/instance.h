...
template < typename ClassT >
inline ClassT*
Instance< ClassT >::clone() const
{
  return new Instance< ClassT >( *this );
}

template < typename ClassT >
inline void* Instance< ClassT >::operator new( size_t size )
{
...
template < typename ClassT >
inline void Instance< ClassT >::operator delete( void* p, size_t size )
{
  if ( p == NULL )
    return;
...
template < typename ClassT >
inline void
Instance< ClassT >::reserve_additional( size_t s )
{
...
template < typename ClassT >
inline size_t
Instance< ClassT >::memory_capacity()
{
...
template < typename ClassT >
inline size_t
Instance< ClassT >::instantiations()
{
