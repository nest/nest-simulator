...
#ifndef EPROP_SYNAPSE_READOUT_H
#define EPROP_SYNAPSE_READOUT_H
...
class eprop_synapse_readout : public eprop_synapse< targetidentifierT >
{
...
template < typename targetidentifierT >
void
eprop_synapse_readout< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
...
template < typename targetidentifierT >
void
eprop_synapse_readout< targetidentifierT >::update_gradient( Node* target,
  double& grad,
