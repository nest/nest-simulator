...
template < typename targetidentifierT >
void
RateConnectionDelayed< targetidentifierT >::get_status( dictionary& d ) const
{
...
template < typename targetidentifierT >
void
RateConnectionDelayed< targetidentifierT >::set_status( const dictionary& d, ConnectorModel& cm )
{
