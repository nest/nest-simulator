...
/* BeginDocumentation
   ...
   Description: The correlospinmatrix_detector is a recording device. It is used to record spikes from
   ...
   The correlospinmatrix_detector has a variable number of inputs which can be set via SetStatus under
   ...
   /cm /correlospinmatrix_detector Create def
...
namespace nest
{
   ...
   *       - update() deletes all entries before now-tau_max, sorts the new entries,
  ...
  inline
  port correlospinmatrix_detector::handles_test_event(SpikeEvent&, rport receptor_type)
  {
  ...
  inline
  void nest::correlospinmatrix_detector::get_status(DictionaryDatum &d) const
  {
  ...
  inline
  void nest::correlospinmatrix_detector::set_status(const DictionaryDatum &d)
  {
    Parameters_ ptmp = P_;
