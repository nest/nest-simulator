...
#ifndef EPROP_SYNAPSE_IAF_PSC_DELTA_H
#define EPROP_SYNAPSE_IAF_PSC_DELTA_H
...
template < typename targetidentifierT >
void
eprop_synapse_iaf_psc_delta< targetidentifierT >::get_status( DictionaryDatum& d ) const
{
...
template < typename targetidentifierT >
void
eprop_synapse_iaf_psc_delta< targetidentifierT >::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
...
template < typename targetidentifierT >
void
eprop_synapse_iaf_psc_delta< targetidentifierT >::update_gradient( EpropArchivingNode* target,
  double& sum_grads,
  std::vector< double >& presyn_isis,
...
template < typename targetidentifierT >
double
eprop_synapse_iaf_psc_delta< targetidentifierT >::get_shift() const
{
  return 0.0;
}
...
#endif // EPROP_SYNAPSE_IAF_PSC_DELTA_H
