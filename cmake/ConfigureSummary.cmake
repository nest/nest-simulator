...
function( NEST_PRINT_CONFIG_SUMMARY )
  ...
  if ( OpenMP_FOUND )
    ...
    string( REPLACE ";" " " _openmp_opts "${_openmp_opts}" )
    string( REPLACE ";" " " _openmp_libs "${_openmp_libs}" )
    message( "Use threading       : Yes (OpenMP: ${_openmp_opts})" )
    message( "    Libraries       : ${_openmp_libs}" )
  else ()
  ...
  if ( HAVE_MPI )
    ...
    string( REPLACE ";" " " _mpi_includes "${_mpi_includes}" )
    string( REPLACE ";" " " _mpi_libs "${_mpi_libs}" )
    string( REPLACE ";" " " _mpi_opts "${_mpi_opts}" )
    message( "Use MPI             : Yes (MPI: ${MPI_CXX_COMPILER})" )
    message( "    Includes        : ${_mpi_includes}" )
    message( "    Libraries       : ${_mpi_libs}" )
    if ( _mpi_opts )
      message( "    Compile Flags   : ${_mpi_opts}" )
    endif ()
  ...
  if ( HAVE_GSL )
    ...
    string( REPLACE ";" " " _gsl_includes "${_gsl_includes}" )
    string( REPLACE ";" " " _gsl_libs "${_gsl_libs}" )
    message( "Use GSL             : Yes (GSL ${GSL_VERSION})" )
    message( "    Includes        : ${_gsl_includes}" )
    message( "    Libraries       : ${_gsl_libs}" )
  else ()
    message( "Use GSL             : No" )
  endif ()
  ...
  message( "" )
  if ( HAVE_BOOST )
    nest_flatten_target_info( Boost::headers _boost_libs _boost_inc _boost_opts )
    string( REPLACE ";" " " _boost_inc "${_boost_inc}" )
