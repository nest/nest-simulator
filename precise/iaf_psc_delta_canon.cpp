...
void nest::iaf_psc_delta_canon::Parameters_::set(const DictionaryDatum& d)
{
...
void nest::iaf_psc_delta_canon::State_::set(const DictionaryDatum& d, const Parameters_& p)
{
