...
void nest::pulsepacket_generator::init_state_(const Node& proto)
{
...
void nest::pulsepacket_generator::init_buffers_()
{
  device_.init_buffers();
}

void nest::pulsepacket_generator::calibrate()
{
  device_.calibrate();
...
void nest::pulsepacket_generator::update(Time const & T, const long_t from, const long_t to)
{
  ...
  {
    n_spikes++;
    prev_spike = B_.spiketimes_.front();
