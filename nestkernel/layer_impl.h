...
Layer< D >::get_global_positions_ntree( NodeCollectionPTR node_collection )
{
  ...
  cached_ntree_ =
    std::shared_ptr< Ntree< D, size_t > >( new Ntree< D, size_t >( this->lower_left_, this->extent_, this->periodic_ ) );
  ...
  NodeCollectionPTR node_collection )
{
  ...
  cached_ntree_ = std::shared_ptr< Ntree< D, size_t > >( new Ntree< D, size_t >( this->lower_left_, extent, periodic ) );
