...
[Documentation](../documentation/index.html). To carry out the code snippets in this handout, you need to import `nest` and `numpy`.
...
Available distributions and associated parameters are described in [Connection_Management](../connection_management/index.html)), the most common ones are:
...
<span><span class="math">`GetConnections(neuron, synapse_model="None"))`</span>:</span>  
