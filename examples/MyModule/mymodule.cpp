 ...
 * defining an instance of your module class in global scope. (LTX_MODULE is defined)
 * This instance must have the name
 *
 * <modulename>_LTX_mod
 *
 ...
 *
 * 3) When you link the library statically with NEST during compilation, the registration
 * will take place in the file `static_modules.h`, which is generated by cmake.
 */
