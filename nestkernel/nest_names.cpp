...
const Name box( "box" );
const Name buffer_shrink_limit( "buffer_shrink_limit" );
const Name buffer_shrink_spare( "buffer_shrink_spare" );
const Name buffer_grow_extra( "buffer_grow_extra" );
const Name buffer_resize_log( "buffer_resize_log" );
