...
function( NEST_PROCESS_WITH_HPC_SYNAPSES )
  set( WITH_HPC_SYNAPSES OFF PARENT_SCOPE )
  if ( with-hpc-synapses )
    if ( with-hpc-synapses STREQUAL "ON" )
        set( WITH_HPC_SYNAPSES ON PARENT_SCOPE )
    endif ()
  endif ()
endfunction()
