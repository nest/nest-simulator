...
void
ConnectionManager::disconnect( const thread tid, const synindex syn_id, const index snode_id, const index tnode_id )
{
...
void
ConnectionManager::sort_connections( const thread tid )
{
