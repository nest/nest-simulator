...
information on writing an extension module, see the section titled ``Writing
an Extension Module'' in the NEST Developer Manual. The basic steps
required to get started are:
\begin{enumerate}
