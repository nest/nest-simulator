...
function( NEST_PROCESS_ENABLE_BLUEGENE )
  ...
  if ( enable-bluegene )
    ...
    elseif ( ${enable-bluegene} STREQUAL "Q" )
      ...
      printError( "Only L/P/Q is allowed for enable-bluegene." )
    endif ()
...
function( NEST_PROCESS_WITH_PYTHON )
  ...
  if ( ${with-python} STREQUAL "2" )
    printError( "Python 2 is not supported anymore, please use Python 3 by setting CMake option -Dwith-python=ON." )
