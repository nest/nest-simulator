...
nest.Connect(nest.AllToAll(cg, neurons, syn_spec=nest.synapsemodels.static(delay=resolution)))
nest.Connect(nest.AllToAll(espikes, neurons, syn_spec=nest.synapsemodels.static(delay=resolution, receptor_type=1)))
nest.Connect(nest.AllToAll(ispikes, neurons, syn_spec=nest.synapsemodels.static(delay=resolution, receptor_type=2)))
nest.Connect(nest.AllToAll(pg, pn, syn_spec=nest.synapsemodels.static(delay=resolution)))
nest.Connect(nest.AllToAll(pn, neurons, syn_spec=nest.synapsemodels.static(delay=resolution, receptor_type=1)))
...
nest.Connect(nest.AllToAll(mm, neurons))
