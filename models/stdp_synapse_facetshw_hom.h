...
project [2,3]_, as for example, 4-bit weight resolution, sequential updates of groups
of synapses and reduced symmetric nearest-neighbor spike pairing scheme. For
details see [3]_.
The modified spike pairing scheme requires the calculation of tau_minus\_
within this synapse and not at the neuron site via Kplus\_ like in
stdp_synapse_hom.
...
-------------------------------------------------------------------------------
 ...
 configbit_0            list of     Configuration bits for evaluation
                        integers    function. For details see code in
                                    function eval_function\_ and [4]_
