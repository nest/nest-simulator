...
{
  insert_( names::V_m,
    &nest::glif_lif_r_asc_a_cond::
      get_y_elem_< nest::glif_lif_r_asc_a_cond::State_::V_M > );
}
}
...
nest::glif_lif_r_asc_a_cond::State_& nest::glif_lif_r_asc_a_cond::State_::
...
void
nest::glif_lif_r_asc_a_cond::State_::get( DictionaryDatum& d,
...
nest::glif_lif_r_asc_a_cond::Buffers_::Buffers_( const Buffers_& b,
  glif_lif_r_asc_a_cond& n )
  : logger_( n )
  , s_( 0 )
  , c_( 0 )
  , e_( 0 )
...
void
nest::glif_lif_r_asc_a_cond::update( Time const& origin,
  const long from,
  const long to )
{
