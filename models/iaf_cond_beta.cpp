...
void
nest::iaf_cond_beta::Parameters_::set( const DictionaryDatum& d, NodeInterface* node )
{
...
void
nest::iaf_cond_beta::State_::set( const DictionaryDatum& d, const Parameters_&, NodeInterface* node )
{
