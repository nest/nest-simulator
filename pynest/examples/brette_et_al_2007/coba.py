...
"""
Benchmark 1 of the simulator review (COBA)
------------------------------------------
...
functions). The model is based on the Vogels & Abbott network model :footcite:p:`Vogels2005`.

This is Benchmark 1 of the FACETS simulator review (Brette et al., 2007) :footcite:p:`Brette2007`:
