...
nest::ht_neuron::Parameters_::set( const DictionaryDatum& d, Node* node )
{
  ...
  updateValueParam< double >(
    d, names::tau_Mg_slow_NMDA, tau_Mg_slow_NMDA, node );
  updateValueParam< double >(
    d, names::tau_Mg_fast_NMDA, tau_Mg_fast_NMDA, node );
  updateValueParam< bool >(
    d, names::instant_unblock_NMDA, instant_unblock_NMDA, node );
  updateValueParam< double >( d, names::g_peak_GABA_A, g_peak_GABA_A, node );
  updateValueParam< double >(
    d, names::tau_rise_GABA_A, tau_rise_GABA_A, node );
  updateValueParam< double >(
  ...
  updateValueParam< double >(
    d, names::tau_rise_GABA_B, tau_rise_GABA_B, node );
  updateValueParam< double >(
    d, names::tau_decay_GABA_B, tau_decay_GABA_B, node );
