...
implemented according to :footcite:p:`Li1994`, :footcite:p:`DeYoung1992`, and
:footcite:p:`Nadkarni2003`. The neurons are modeled with ``aeif_cond_alpha_astro``,
...
:doc:`astrocyte_small_network`, :doc:`astrocyte_brunel_bernoulli`
