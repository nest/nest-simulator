...
public:
  ...
  stdp_nn_restr_synapse( const stdp_nn_restr_synapse& rhs, const size_t ) : stdp_nn_restr_synapse( rhs ) {};
...
template < typename targetidentifierT >
void
stdp_nn_restr_synapse< targetidentifierT >::set_status( const DictionaryDatum& d, const size_t tid, ConnectorModel& cm )
{
